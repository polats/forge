...
_See code: [src\commands\create.ts](https://github.com/polats/forge/blob/v0.4.0/src\commands\create.ts)_
...
_See code: [src\commands\init.ts](https://github.com/polats/forge/blob/v0.4.0/src\commands\init.ts)_
<!-- commandsstop -->
* [`forge create [FILE]`](#forge-create-file)
* [`forge help [COMMAND]`](#forge-help-command)
* [`forge init [FILE]`](#forge-init-file)
